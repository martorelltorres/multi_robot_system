...
class MultiRobotSystem:
    ...
    def __init__(self, name):
        ...
        self.turbot_position_initialized = False
    ...
    def update_turbot_position(self,msg):
        ...
        self.turbot_position_initialized = True
    ...
    def update_xiroi_position(self,msg):
        xiroi_position_north = msg.position.north
        xiroi_position_east = msg.position.east
        self.xiroi_yaw = msg.orientation.yaw
        self.xiroi_position_initialized = True
    ...
    def mrs_coverage(self,goal_polygon,vehicle):
        self.data_gattered = True
        # obtain all the polygons goal_points
        self.goal_points = self.area_handler.define_path_coverage(goal_polygon)
        self.polygon_goal_points = self.goal_points[goal_polygon]
        ...
        for self.section in range((len(all_sections)-1)):
            ...
            if (self.section==0):
                ...
                yaw = self.turbot_yaw
                self.send_section_strategy(initial_point,final_point,yaw,vehicle)
    ...
    def send_section_strategy(self,initial_point,final_point,yaw,vehicle):
